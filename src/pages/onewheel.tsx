export default function onewheel() {
    return (
        <>
  <meta charSet="UTF-8" />
  <title>Onewheel - Electrium Mobility</title>
  <meta
    name="viewport"
  ...
  <section className="relative table w-full py-32 lg:py-40 bg-gray-50 dark:bg-slate-800">
    <div className="container">
      <div className="grid grid-cols-1 text-center mt-10">
        <h3 className="text-3xl leading-normal font-semibold">Onewheel</h3>
      </div>
      {/*end grid*/}
    </div>
    {/*end container*/}
        ...
        <div className="lg:col-span-8 md:col-span-7">
          <div className="ltr:lg:mr-5 rtl:lg:ml-5">
            ...
            <p className="text-slate-400">
              The Electric One-Wheel project aims to revolutionize personal
              mobility by creating a cutting-edge, electric-powered single-wheel
              vehicle. This innovative mode of transportation will offer users a
              thrilling and dynamic experience while providing an eco-friendly
              alternative to traditional means of commuting. As a design team,
              our goal is to create a sleek, ergonomic, and high-performance
              one-wheel device that prioritizes safety, efficiency, and user
              comfort.
            </p>
